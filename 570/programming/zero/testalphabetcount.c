...
int main()
{
	  char *path = "/home/cs/zhengli/cssc2375/programming/data";           // the data *.txt files are under this folder
	  char *filetowrite = "/home/cs/zhengli/cssc2375/programming/result/result.txt";    // the frequency of all alphabetical letters will be written in this file
